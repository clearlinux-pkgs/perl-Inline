...
Version  : 0.81
Release  : 9
URL      : https://cpan.metacpan.org/authors/id/T/TI/TINITA/Inline-0.81.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/Inline-0.81.tar.gz
...
%prep
%setup -q -n Inline-0.81
cd ..
%setup -q -T -D -n Inline-0.81 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Inline-0.81/deblicense/
