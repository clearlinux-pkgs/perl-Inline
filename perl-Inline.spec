...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/Inline-0.83.tar.gz
...
%prep
%setup -q -n Inline-0.83
cd ..
%setup -q -T -D -n Inline-0.83 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Inline-0.83/deblicense/
